...
// let gugunSel = document.querySelector("#gugun");
  ...
  queryParams +=
  "&" + encodeURIComponent("aptName") + "=" + encodeURIComponent(aptName); /* 아파트명*/
//  queryParams +=
//	    "&" + encodeURIComponent("DEAL_YD") + "=" + encodeURIComponent(year); /* 조회년 */
//  queryParams +=
//	    "&" + encodeURIComponent("DEAL_MD") + "=" + encodeURIComponent(month); /* 조회월 */
// queryParams +=
